$(function(){
    ...
    $('.btn-add-phone').click(function(){
        ...
        $('.phone-list').append(''+ '<div class="input-group phone-input">'+ '<span class="input-group-btn">'+
...
'<ul class="dropdown-menu" role="menu">'+
        ...
        '<li><a class="changeType" href="javascript:;" data-type-value="mobile">Mobile</a></li>'+ '</ul>'+
    '</span>'+
